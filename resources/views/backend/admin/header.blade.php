                     ...
                     <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <div class="header-message-list">
                           ...
                           <a class="dropdown-item" href="javascript:;">
                              <div class="d-flex align-items-center">
                                 <div class="user-online">
                                    <img src="{{ asset('backend/assets/images/avatars/avatar-10.pn') }}g" class="msg-avatar" alt="user avatar">
                                 </div>
                                 <div class="flex-grow-1">
                           ...
                           <a class="dropdown-item" href="javascript:;">
                              <div class="d-flex align-items-center">
                                 <div class="user-online">
                                    <img src="{{ asset('backend/assets/images/avatars/avatar-11.pn') }}g" class="msg-avatar" alt="user avatar">
                                 </div>
                                 <div class="flex-grow-1">
